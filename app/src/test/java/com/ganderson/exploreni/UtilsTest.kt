...
class UtilsTest {
    ...
    fun getHaversineGCDTest() {
        ...
        assertTrue(distanceAsBigDecimal.toDouble() == expectedDistance)
    }
    ...
    fun distanceToImperialTest() {
        ...
        assertTrue(imperialDistanceAsBigDecimal.toDouble() == expectedImperialDistance)
    }
    ...
    fun distanceToMetricTest() {
        ...
        val metricDistanceAsBigDecimal = BigDecimal(metricDistance)
            .setScale(2, RoundingMode.HALF_UP)
        assertTrue(metricDistanceAsBigDecimal.toDouble() == expectedMetricDistance)
    }
    ...
    fun secondsToTimeStringTestMinutes() {
        ...
        assertTrue(timeString == expectedTimeString)
    }
